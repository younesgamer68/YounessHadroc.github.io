...
<body>
    ...
    <div class="login-container">
        ...
        <h2>EYE WEAR Login</h2>
        <?php if (!empty($_SESSION['login_message'])): ?>
            <div class="alert-info"><?php echo $_SESSION['login_message']; ?></div>
        ...
        <form method="post" action="login.php">
            ...
            <button type="submit" class="floating">Login <i class="fas fa-arrow-right"></i></button>
        </form>
